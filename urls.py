...
urlpatterns = [
    ...
    path('job seeker_login/', views.job seeker_login, name="job seeker_login"),
 ...
 # Admin dashboard and actions
    ...
    path("accounts/login/", job_views.job seeker_login, name="login"),
    ...
    # Profile updates
    path('update_job seeker/', views.update_job seeker_profile, name="update_job seeker_profile"),
